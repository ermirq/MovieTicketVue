...
<template>
  <div class="bg-gray-800 bg-opacity-70 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow mb-10 duration-300">
    <div class="relative w-full mb-2">
      ...
      <div v-if="isAdmin" class="absolute right-0 top-1/2 -translate-y-1/2">
        <AdminActions @edit="editCinema" @delete="deleteCinema" />
      </div>
    </div>
